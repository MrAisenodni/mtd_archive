...
@section('content')
    <main class="page-content">
        ...
        <!--end breadcrumb-->
        <h6 class="mb-0 text-uppercase">Detail Perusahaan</h6>
        <hr/>
        <div class="row">
            @if (session('status'))
                <div class="col-12">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-12">
                                            ...
                                            <select class="select-wards form-control @error('provider_ward') is-invalid @enderror" id="provider_ward" name="provider_ward">
                                                ...
                                                @if ($detail->provider_ward_id)
                                                    <option value="{{ $detail->provider_ward->id }}" selected>[{{ $detail->provider_ward->post_code }}] {{ $detail->provider_ward->name }}</option>
                                                @endif
                                            </select>
                                            @error('provider_ward')
                                                <div class="invalid-feedback">{{ $message }}</div>
