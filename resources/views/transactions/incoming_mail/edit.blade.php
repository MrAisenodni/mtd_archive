                        ...
                        <form action="{{ $menu->url }}/{{ $detail->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-2">
                                <div class="col-12">
                                    ...
                                    <textarea name="letter_address" id="letter_address" class="form-control" cols="30" rows="10">{!! old('letter_address', $detail->letter_address) !!}</textarea>
                                    ...
                                    <select class="single-select form-control @error('letter_status') is-invalid @enderror" id="letter_status" name="letter_status">
                                        ...
                                        @if ($letter_statuses)
                                            @foreach ($letter_statuses as $item)
                                                <option value="{{ $item->id }}" @if(old('letter_status', $detail->letter_status_id) == $item->id) selected @endif>{{ $item->full_name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @error('letter_status')
