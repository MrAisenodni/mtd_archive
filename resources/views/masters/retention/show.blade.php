<form class="row g-3" action="{{ $menu->url }}/{{ $detail->id }}" method="POST">
    ...
    <div class="col-12">
        ...
        <input type="text" class="form-control @error('time') is-invalid @enderror" id="time" name="time" value="{{ old('time', $detail->time) }}" disabled>
        @error('time')
    ...
    <div class="col-12">
        ...
        <select class="single-select form-control @error('type') is-invalid @enderror" id="type" name="type" disabled>
