...
@section('content')
    <main class="page-content">
        <input type="hidden" value="{{ $menu->url }}" id="url" disabled>
        <!--breadcrumb-->
                        ...
                        <form action="{{ $menu->url }}/{{ $detail->id }}" method="POST">
                            ...
                            <div class="row mb-2">
                                <div class="col-12">
                                    ...
                                    <textarea name="address_1" id="address_1" cols="30" rows="5" class="form-control @error('address_1') is-invalid @enderror" disabled>{{ old('address_1', $detail->address_1) }}</textarea>
                                    @error('address_1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-8">
                                    ...
                                    <input type="text" class="form-control @error('ward') is-invalid @enderror" id="ward" name="ward" value="@if ($detail->ward) {{ old('ward', $detail->ward->name) }} @endif" disabled>
                                    @error('ward')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control @error('phone_no_1') is-invalid @enderror" id="phone_no_1" name="phone_no_1" value="{{ old('phone_no_1', $detail->phone_no_1) }}" disabled>
                                    @error('phone_no_1')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control @error('phone_no_2') is-invalid @enderror" id="phone_no_2" name="phone_no_2" value="{{ old('phone_no_2', $detail->phone_no_2) }}" disabled>
                                    @error('phone_no_2')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control @error('phone_no_3') is-invalid @enderror" id="phone_no_3" name="phone_no_3" value="{{ old('phone_no_3', $detail->phone_no_3) }}" disabled>
                                    @error('phone_no_3')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-3">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $detail->email) }}" disabled>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
