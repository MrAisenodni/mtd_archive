                        ...
                        <form action="{{ $menu->url }}/{{ $detail->id }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('group') is-invalid @enderror" id="group" name="group" value="{{ old('group', $detail->department_group->name) }}" disabled>
                                    @error('group')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control @error('manager') is-invalid @enderror" id="manager" name="manager" value="{{ old('manager', $detail->manager->full_name) }}" disabled>
                                    @error('manager')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
