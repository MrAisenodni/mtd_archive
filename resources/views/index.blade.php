                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="project-user-groups">
                            <img src="{{ ('/images/avatars/avatar-1.png') }}" width="35" height="35" class="rounded-circle" alt="">
                            <img src="{{ ('/images/avatars/avatar-2.png') }}" width="35" height="35" class="rounded-circle" alt="">
                        </div>
